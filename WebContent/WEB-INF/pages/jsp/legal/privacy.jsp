...
<c:set var="pageTitle" value="${bundle['legal.privacy_policy']}" scope="request" />
<c:set var="pageHeading" value="${bundle['legal.privacy_policy']}" scope="request" />

<c:import url="${config.viewDir}inc/header.inc.jsp" />

This Privacy Policy governs the manner in which ${config.siteName} collects, uses, maintains and discloses information collected from users (each, a "User") of the <a href="${config.siteUrl}">${config.siteUrl}</a> website ("Site"). This privacy policy applies to the Site and all products and services offered by ${config.siteName}.<br><br>
...
${config.siteName} collects and uses Users personal information for the following purposes:<br>
<ul>
...
${config.siteName} has the discretion to update this privacy policy at any time. When we do, we will revise the updated date at the bottom of this page. We encourage Users to frequently check this page for any changes to stay informed about how we are helping to protect the personal information we collect. You acknowledge and agree that it is your responsibility to review this privacy policy periodically and become aware of modifications.<br><br>
...
privacy practices of this site, please contact us via our &quot;<a href="<c:url value="${config.rewriteUrl}main/contact" />" title="Contact Us">contact form</a>&quot;<br>

<a href="${config.siteUrl}">${config.siteUrl}</a><br>
<br>
