...
<c:set var="pageTitle" value="${bundle['help.me']}" scope="request" />
<c:set var="pageHeading" value="${bundle['help.me']}" scope="request" />
...
<c:import url="${config.viewDir}inc/header.inc.jsp" />
 ...
 <section class="row">
  ...
  <p class="italic gray">Contact me at: <a href="mailto:${config.contactEmail}">${config.contactEmail}</a></p>
